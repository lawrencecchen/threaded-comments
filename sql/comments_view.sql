...
create recursive view comments_thread (
    ...
    select
        ...
        array[id]::bigint[] as "pathVotesRecent",
        array[id]::bigint[] as "pathLeastRecent",
        array[id]::bigint[] as "pathMostRecent"
    from
    ...
    select
        ...
        p2."pathVotesRecent" || -p1."votes" || -cast(extract(epoch from p1."createdAt") as bigint) || p1.id::bigint as "pathVotesRecent",
        p2."pathLeastRecent" || cast(extract(epoch from p1."createdAt") as bigint) || p1.id::bigint as "pathLeastRecent",
        p2."pathMostRecent" || -cast(extract(epoch from p1."createdAt") as bigint) || p1.id::bigint as "pathMostRecent"
    from
